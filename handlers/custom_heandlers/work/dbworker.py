...
path = r'C:\Users\saifu\PycharmProjects\Skillbox\Python_Basic\python_basic_diploma\database\history.db'
...
def get_history(chat_id: str) -> list:
    ...
    history = get_data(
        string=f"SELECT uid, datetime, city, command from history WHERE chat_id = '{chat_id}'")
    return history
